...
#define VFD_DA_H	(HAL_GPIO_WritePin(GPIOD, GPIO_PIN_0,  GPIO_PIN_SET))
#define VFD_DA_L	(HAL_GPIO_WritePin(GPIOD, GPIO_PIN_0,  GPIO_PIN_RESET))

#define VFD_RS_H 	(HAL_GPIO_WritePin(GPIOD, GPIO_PIN_1,  GPIO_PIN_SET))
#define VFD_RS_L	(HAL_GPIO_WritePin(GPIOD, GPIO_PIN_1,  GPIO_PIN_RESET))

#define VFD_CE_H	(HAL_GPIO_WritePin(GPIOD, GPIO_PIN_2,  GPIO_PIN_SET))
#define VFD_CE_L	(HAL_GPIO_WritePin(GPIOD, GPIO_PIN_2,  GPIO_PIN_RESET))

#define VFD_CLK_H	(HAL_GPIO_WritePin(GPIOD, GPIO_PIN_3,  GPIO_PIN_SET))
#define VFD_CLK_L	(HAL_GPIO_WritePin(GPIOD, GPIO_PIN_3,  GPIO_PIN_RESET))
